...
function addTeamView(id, name, score) {
    ...
    // Update the click handler to use the new AJAX function
...
function increase_score(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            display_scoreboard(response); // Make sure to pass the sorted scoreboard from the response
        },
...
$(document).ready(function() {
    display_scoreboard(scoreboard); // Ensure initial rendering from the server-side provided list
});
